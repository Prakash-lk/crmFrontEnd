                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <div className = "form-group">
                                            ...
                                            <input placeholder="YYYY-MM-DDTHH:MM:SS" name="createdAt" className="form-control" 
                                                value={this.state.createdAt} onChange={this.changeCreatedAtHandler}/>
                                        </div>
                                        <div className = "form-group">
                                            <label> Updated At: </label>
                                            <input placeholder="YYYY-MM-DDTHH:MM:SS" name="updatedAt" className="form-control" 
